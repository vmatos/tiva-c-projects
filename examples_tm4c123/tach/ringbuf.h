...
extern uint32_t RingBufReadOne(tRingBufObject *psRingBuf);
extern void RingBufRead(tRingBufObject *psRingBuf, uint32_t *pui32Data,
                        uint32_t ui32Length);
extern void RingBufWriteOne(tRingBufObject *psRingBuf, uint32_t ui32Data);
extern void RingBufWrite(tRingBufObject *psRingBuf, uint32_t *pui32Data,
                         uint32_t ui32Length);
extern void RingBufAdvanceWrite(tRingBufObject *psRingBuf,
                                uint32_t ui32NumBytes);
extern void RingBufAdvanceRead(tRingBufObject *psRingBuf,
                                uint32_t ui32NumBytes);
extern void RingBufInit(tRingBufObject *psRingBuf, uint32_t *pui32Buf,
                        uint32_t ui32Size);
