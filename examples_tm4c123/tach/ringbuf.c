...
RingBufReadOne(tRingBufObject *psRingBuf)
{
    ...
    // Write the data byte.
    //
    ui32Temp = psRingBuf->pui32Buf[psRingBuf->ui32ReadIndex];
...
//! \param pui32Data points to where the data should be stored.
...
//*****************************************************************************
void
RingBufRead(tRingBufObject *psRingBuf, uint32_t *pui32Data, uint32_t ui32Length)
{
    uint32_t ui32Temp;
    ...
    {
        pui32Data[ui32Temp] = RingBufReadOne(psRingBuf);
    }
}
...
//!
//! \param psRingBuf points to the ring buffer to be written to.
//! \param ui32Data is the byte to be written.
//!
...
//*****************************************************************************
void
RingBufWriteOne(tRingBufObject *psRingBuf, uint32_t ui32Data)
{
    //
    // Check the arguments.
    //
    ...
    // Write the data byte.
    //
    psRingBuf->pui32Buf[psRingBuf->ui32WriteIndex] = ui32Data;
...
//!
//! \param psRingBuf points to the ring buffer to be written to.
//! \param pui32Data points to the data to be written.
...
//*****************************************************************************
void
RingBufWrite(tRingBufObject *psRingBuf, uint32_t *pui32Data,
             uint32_t ui32Length)
{
    uint32_t ui32Temp;
    ...
    for(ui32Temp = 0; ui32Temp < ui32Length; ui32Temp++)
    {
        RingBufWriteOne(psRingBuf, pui32Data[ui32Temp]);
    }
}
...
//! \param pui32Buf points to the data buffer to be used for the ring buffer.
...
//*****************************************************************************
void
RingBufInit(tRingBufObject *psRingBuf, uint32_t *pui32Buf,
            uint32_t ui32Size)
{
    //
    // Check the arguments.
