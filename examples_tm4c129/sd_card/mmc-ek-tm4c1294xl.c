...
/* TX pin */
#define SDC_SSI_TX_GPIO_PORT_BASE   GPIO_PORTQ_BASE
#define SDC_SSI_TX              GPIO_PIN_2
/* RX pin */
#define SDC_SSI_RX_GPIO_PORT_BASE   GPIO_PORTQ_BASE
#define SDC_SSI_RX              GPIO_PIN_3
/* CS pin */
#define SDC_SSI_FSS_GPIO_PORT_BASE   GPIO_PORTQ_BASE
